...
class GeneralTests(TestCase):
    ...
    def test_align_image_only(self):
        ...
        self.assertEquals(result, u'<div style="vertical-align:middle;display:inline-block;width:80%"><img/></div>')

    def test_align_text_only(self):
        content = "Test"
        result = align(content)
        self.assertEquals(result, u'<div style="vertical-align:middle;display:inline-block;width:80%">Test</div>')

    def test_align_text_and_image(self):
        content = "<b>Test</b><img/>"
        result = align(content)
        self.assertEquals(result, u'<div style="vertical-align:middle;display:inline-block;width:80%"><b>Test</b><img/></div>')

    def test_align_double_image(self):
        content = "<img/><img/>"
        result = align(content)
        self.assertEquals(result, u'<div style="vertical-align:middle;display:inline-block;width:80%"><img/><img/></div>')

    def test_align_then_strip(self):
        content = "<b>Test</b><p></p><img/>"
        result = align(content)
        output = strip_tags(result)
        self.assertEquals(output, u'<div style="vertical-align:middle;display:inline-block;width:80%"><b>Test</b><img/></div>')
