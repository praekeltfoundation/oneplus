...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerState.golden_egg_question'
        db.add_column(u'oneplus_learnerstate', 'golden_egg_question',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerState.golden_egg_question'
        db.delete_column(u'oneplus_learnerstate', 'golden_egg_question')
