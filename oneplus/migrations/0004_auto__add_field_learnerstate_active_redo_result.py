...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerState.active_redo_result'
        db.add_column(u'oneplus_learnerstate', 'active_redo_result',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerState.active_redo_result'
        db.delete_column(u'oneplus_learnerstate', 'active_redo_result')
