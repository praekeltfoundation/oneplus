...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerState.redo_question'
        db.add_column(u'oneplus_learnerstate', 'redo_question',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='rquestion', null=True, to=orm['content.TestingQuestion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerState.redo_question'
        db.delete_column(u'oneplus_learnerstate', 'redo_question_id')
