...
class Migration(DataMigration):
    ...
    depends_on = (
        ("gamification", "0015_add_leveling_badge"),
    )
    ...
    def forwards(self, orm):
        ...
        for i in xrange(1, 8):
            badge = orm['gamification.GamificationBadgeTemplate'].objects.get(name="Level {0:d}".format(i))
            badge.image = "img/badges/badge_level_{0:d}.png".format(i)
            badge.save()
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 28, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
        ...
        u'oneplus.learnerstate': {
            ...
            'active_question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aquestion'", 'null': 'True', 'to': u"orm['content.TestingQuestion']"}),
            'active_redo_result': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'active_result': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'golden_egg_question': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']", 'null': 'True'}),
            'redo_question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rquestion'", 'null': 'True', 'to': u"orm['content.TestingQuestion']"}),
            'sumit_level': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'sumit_question': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
