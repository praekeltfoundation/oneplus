...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for i in xrange(1, 6):
            sumit_level = orm['content.SUMitLevel'].objects.get(order=i)
            sumit_level.image = "img/sumit/splash_sumit_{0:02d}.png".format(i)
            sumit_level.save()
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 27, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
