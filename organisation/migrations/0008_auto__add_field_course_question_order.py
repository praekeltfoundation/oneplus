...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.question_order'
        db.add_column(u'organisation_course', 'question_order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.question_order'
        db.delete_column(u'organisation_course', 'question_order')
