...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.open_type'
        db.add_column(u'organisation_school', 'open_type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.open_type'
        db.delete_column(u'organisation_school', 'open_type')
