...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Module.module_link'
        db.add_column(u'organisation_module', 'module_link',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Module.module_link'
        db.delete_column(u'organisation_module', 'module_link')
