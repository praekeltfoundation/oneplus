...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipantRedoQuestionAnswer'
        db.create_table(u'core_participantredoquestionanswer', (
    ...
    def backwards(self, orm):
        # Deleting model 'ParticipantRedoQuestionAnswer'
        db.delete_table(u'core_participantredoquestionanswer')
