...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ParticipantQuestionAnswer', fields ['answerdate']
        db.create_index(u'core_participantquestionanswer', ['answerdate'])

        # Adding index on 'ParticipantQuestionAnswer', fields ['correct']
        db.create_index(u'core_participantquestionanswer', ['correct'])


    def backwards(self, orm):
        # Removing index on 'ParticipantQuestionAnswer', fields ['correct']
        db.delete_index(u'core_participantquestionanswer', ['correct'])

        # Removing index on 'ParticipantQuestionAnswer', fields ['answerdate']
        db.delete_index(u'core_participantquestionanswer', ['answerdate'])
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 2, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 2, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 2, 0, 0)', 'null': 'True', 'db_index': 'True'}),
