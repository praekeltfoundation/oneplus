...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.learner'
        db.alter_column(u'core_participant', 'learner_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Learner'], unique=True))
        # Adding unique constraint on 'Participant', fields ['learner']
        db.create_unique(u'core_participant', ['learner_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Participant', fields ['learner']
        db.delete_unique(u'core_participant', ['learner_id'])


        # Changing field 'Participant.learner'
        db.alter_column(u'core_participant', 'learner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Learner']))
    ...
    models = {
        ...
        u'core.participant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'learner': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.Learner']", 'unique': 'True'}),
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 16, 0, 0)', 'null': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
