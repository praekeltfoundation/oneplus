...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        message = "Welcome to dig-it! Your password is: %s. " \
                  "Log in by going to this link: http://www.dig-it.co.za/login/a/%s"
        obj = orm.Setting.objects.get(key="WELCOME_SMS")
        obj.value = message
        obj.save()
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 26, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 26, 0, 0)', 'null': 'True', 'db_index': 'True'}),
        ...
        u'core.participantredoquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 26, 0, 0)', 'null': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'option_selected': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.TestingQuestionOption']"}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
