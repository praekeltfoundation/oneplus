...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ParticipantQuestionAnswer.answerdate'
        db.alter_column(u'core_participantquestionanswer', 'answerdate', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Participant.datejoined'
        db.alter_column(u'core_participant', 'datejoined', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Class.startdate'
        db.alter_column(u'core_class', 'startdate', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Class.enddate'
        db.alter_column(u'core_class', 'enddate', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ParticipantQuestionAnswer.answerdate'
        db.alter_column(u'core_participantquestionanswer', 'answerdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Participant.datejoined'
        db.alter_column(u'core_participant', 'datejoined', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Class.startdate'
        db.alter_column(u'core_class', 'startdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Class.enddate'
        db.alter_column(u'core_class', 'enddate', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 12, 0, 0)', 'null': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
