...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeacherClass'
        db.create_table(u'core_teacherclass', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Teacher'])),
            ('classs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Class'])),
        ))
        db.send_create_signal(u'core', ['TeacherClass'])


    def backwards(self, orm):
        # Deleting model 'TeacherClass'
        db.delete_table(u'core_teacherclass')
    ...
    models = {
        ...
        u'auth.learner': {
            ...
            'questions_completed': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'questions_correct': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
        ...
        u'core.participantquestionanswer': {
            ...
            'answerdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 20, 0, 0)', 'null': 'True'}),
            'correct': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
