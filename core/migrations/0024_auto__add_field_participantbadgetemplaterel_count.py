...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ParticipantBadgeTemplateRel.count'
        db.add_column(u'core_participantbadgetemplaterel', 'count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ParticipantBadgeTemplateRel.count'
        db.delete_column(u'core_participantbadgetemplaterel', 'count')
