...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SUMit'
        db.create_table(u'content_sumit', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content.Event'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'content', ['SUMit'])


    def backwards(self, orm):
        # Deleting model 'SUMit'
        db.delete_table(u'content_sumit')
