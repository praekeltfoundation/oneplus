...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoldenEggRewardLog.points'
        db.add_column(u'content_goldeneggrewardlog', 'points',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GoldenEggRewardLog.airtime'
        db.add_column(u'content_goldeneggrewardlog', 'airtime',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoldenEggRewardLog.points'
        db.delete_column(u'content_goldeneggrewardlog', 'points')

        # Deleting field 'GoldenEggRewardLog.airtime'
        db.delete_column(u'content_goldeneggrewardlog', 'airtime')
