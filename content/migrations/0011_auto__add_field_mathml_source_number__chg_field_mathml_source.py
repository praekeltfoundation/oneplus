...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mathml.source_number'
        db.add_column(u'content_mathml', 'source_number',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


        # Changing field 'Mathml.source'
        db.alter_column(u'content_mathml', 'source', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):
        # Deleting field 'Mathml.source_number'
        db.delete_column(u'content_mathml', 'source_number')


        # Changing field 'Mathml.source'
        db.alter_column(u'content_mathml', 'source', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'content.mathml': {
            ...
            'source_number': ('django.db.models.fields.IntegerField', [], {'max_length': '1'})
        },
