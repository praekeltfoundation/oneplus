...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SUMitEndPage'
        db.create_table(u'content_sumitendpage', (
            (u'eventendpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content.EventEndPage'], unique=True, primary_key=True)),
            ('type', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'content', ['SUMitEndPage'])


    def backwards(self, orm):
        # Deleting model 'SUMitEndPage'
        db.delete_table(u'content_sumitendpage')
