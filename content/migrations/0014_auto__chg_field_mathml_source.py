...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'content_mathml', 'source', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1))
    ...
    models = {
        ...
        u'content.mathml': {
            ...
            'source': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '1'}),
