...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GoldenEggRewardLog'
        db.create_table(u'content_goldeneggrewardlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Participant'])),
            ('award_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('points', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
            ('airtime', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
            ('badge', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gamification.GamificationScenario'], null=True, blank=True)),
        ))
        db.send_create_signal(u'content', ['GoldenEggRewardLog'])


    def backwards(self, orm):
        # Deleting model 'GoldenEggRewardLog'
        db.delete_table(u'content_goldeneggrewardlog')
    ...
    models = {
        ...
        u'content.goldeneggrewardlog': {
            ...
            'airtime': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            ...
            'points': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'})
        },
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
