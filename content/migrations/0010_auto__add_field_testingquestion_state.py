...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestingQuestion.state'
        db.add_column(u'content_testingquestion', 'state',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestingQuestion.state'
        db.delete_column(u'content_testingquestion', 'state')
