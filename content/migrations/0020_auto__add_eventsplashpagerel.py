...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventSplashPageRel'
        db.create_table(u'content_eventsplashpagerel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Event'], null=True)),
            ('splash_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.EventSplashPage'], null=True)),
            ('order_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
        ))
        db.send_create_signal(u'content', ['EventSplashPageRel'])


    def backwards(self, orm):
        # Deleting model 'EventSplashPageRel'
        db.delete_table(u'content_eventsplashpagerel')
    ...
    models = {
        ...
        u'content.event': {
            ...
            'end_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.EventEndPage']", 'null': 'True'}),
            ...
            'start_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.EventStartPage']", 'null': 'True'})
        },
        ...
        u'content.eventsplashpagerel': {
            'Meta': {'object_name': 'EventSplashPageRel'},
            ...
            'splash_page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.EventSplashPage']", 'null': 'True'})
        },
        ...
        u'core.participantbadgetemplaterel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'null': 'True'}),
        ...
        u'core.participantpointbonusrel': {
            ...
            'awarddate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']"}),
