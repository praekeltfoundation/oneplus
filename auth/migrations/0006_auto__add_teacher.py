...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auth_teacher', (
            ...
            ('welcome_message_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('welcome_message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Sms'], null=True, blank=True)),
            ('last_active_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'auth', ['Teacher'])


    def backwards(self, orm):
        # Deleting model 'Teacher'
        db.delete_table(u'auth_teacher')
