...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sms.uuid'
        db.add_column(u'auth_sms', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sms.uuid'
        db.delete_column(u'auth_sms', 'uuid')
    ...
    models = {
        ...
        u'auth.learner': {
            ...
            'welcome_message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Sms']", 'null': 'True', 'blank': 'True'}),
