...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Learner.welcome_message'
        db.alter_column(u'auth_learner', 'welcome_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Sms'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'auth_sms', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal(u'auth', ['Sms'])


        # Changing field 'Learner.welcome_message'
        db.alter_column(u'auth_learner', 'welcome_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Sms'], null=True))
