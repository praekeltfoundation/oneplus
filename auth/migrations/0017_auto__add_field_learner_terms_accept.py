...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Learner.terms_accept'
        db.add_column(u'auth_learner', 'terms_accept',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Learner.terms_accept'
        db.delete_column(u'auth_learner', 'terms_accept')
