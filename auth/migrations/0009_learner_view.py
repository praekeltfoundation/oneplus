...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'auth.learnerview': {
            'Meta': {'managed': 'False', 'object_name': 'LearnerView', 'db_table': "'view_learner'", '_ormbases': [u'auth.Learner']},
            u'learner_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.Learner']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'auth.permission': {
