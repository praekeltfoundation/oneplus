...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Learner.public_share'
        db.add_column(u'auth_learner', 'public_share',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Learner.public_share'
        db.delete_column(u'auth_learner', 'public_share')
