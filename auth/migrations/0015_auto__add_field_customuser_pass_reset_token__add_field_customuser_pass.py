...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.pass_reset_token'
        db.add_column(u'auth_customuser', 'pass_reset_token',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.pass_reset_token_expiry'
        db.add_column(u'auth_customuser', 'pass_reset_token_expiry',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.pass_reset_token'
        db.delete_column(u'auth_customuser', 'pass_reset_token')

        # Deleting field 'CustomUser.pass_reset_token_expiry'
        db.delete_column(u'auth_customuser', 'pass_reset_token_expiry')
