...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communication_ban', (
            ...
            ('source_pk', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'communication', ['Ban'])


    def backwards(self, orm):
        # Deleting model 'Ban'
        db.delete_table(u'communication_ban')
    ...
    models = {
        ...
        u'communication.moderation': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'moderation_author'", 'null': 'True', 'to': u"orm['auth.CustomUser']"}),
            ...
            'unmoderated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'moderation_unmoderator'", 'null': 'True', 'to': u"orm['auth.CustomUser']"}),
            'unmoderated_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
