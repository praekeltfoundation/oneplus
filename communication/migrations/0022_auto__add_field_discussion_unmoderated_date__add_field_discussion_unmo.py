...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.unmoderated_date'
        db.add_column(u'communication_discussion', 'unmoderated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Discussion.unmoderated_by'
        db.add_column(u'communication_discussion', 'unmoderated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='discussion_unmoderated_user', null=True, to=orm['auth.CustomUser']),
                      keep_default=False)

        # Adding field 'Discussion.original_content'
        db.add_column(u'communication_discussion', 'original_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.moderated'
        db.add_column(u'communication_chatmessage', 'moderated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ChatMessage.unmoderated_date'
        db.add_column(u'communication_chatmessage', 'unmoderated_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.unmoderated_by'
        db.add_column(u'communication_chatmessage', 'unmoderated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='chatmessage_unmoderated_user', null=True, to=orm['auth.CustomUser']),
                      keep_default=False)

        # Adding field 'ChatMessage.original_content'
        db.add_column(u'communication_chatmessage', 'original_content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discussion.unmoderated_date'
        db.delete_column(u'communication_discussion', 'unmoderated_date')

        # Deleting field 'Discussion.unmoderated_by'
        db.delete_column(u'communication_discussion', 'unmoderated_by_id')

        # Deleting field 'Discussion.original_content'
        db.delete_column(u'communication_discussion', 'original_content')

        # Deleting field 'ChatMessage.moderated'
        db.delete_column(u'communication_chatmessage', 'moderated')

        # Deleting field 'ChatMessage.unmoderated_date'
        db.delete_column(u'communication_chatmessage', 'unmoderated_date')

        # Deleting field 'ChatMessage.unmoderated_by'
        db.delete_column(u'communication_chatmessage', 'unmoderated_by_id')

        # Deleting field 'ChatMessage.original_content'
        db.delete_column(u'communication_chatmessage', 'original_content')
