...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # move the response to reply
        for disc in orm.Discussion.objects.all():
            disc.reply = disc.response
            disc.save()

        # make the response None
        for disc in orm.Discussion.objects.all():
            disc.response = None
            disc.save()

    def backwards(self, orm):
        # move the reply back to response
        for disc in orm.Discussion.objects.all():
            disc.respone = disc.reply
            disc.save()
