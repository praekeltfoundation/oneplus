...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiscussionLike'
        db.create_table(u'communication_discussionlike', (
            ...
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Discussion'])),
        ))
        db.send_create_signal(u'communication', ['DiscussionLike'])

        # Adding unique constraint on 'DiscussionLike', fields ['user', 'comment']
        db.create_unique(u'communication_discussionlike', ['user_id', 'comment_id'])

        # Adding model 'PostCommentLike'
        db.create_table(u'communication_postcommentlike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.PostComment'])),
        ))
        db.send_create_signal(u'communication', ['PostCommentLike'])

        # Adding unique constraint on 'PostCommentLike', fields ['user', 'comment']
        db.create_unique(u'communication_postcommentlike', ['user_id', 'comment_id'])

        # Adding model 'ChatMessageLike'
        db.create_table(u'communication_chatmessagelike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.ChatMessage'])),
        ))
        db.send_create_signal(u'communication', ['ChatMessageLike'])

        # Adding unique constraint on 'ChatMessageLike', fields ['user', 'comment']
        db.create_unique(u'communication_chatmessagelike', ['user_id', 'comment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ChatMessageLike', fields ['user', 'comment']
        db.delete_unique(u'communication_chatmessagelike', ['user_id', 'comment_id'])

        # Removing unique constraint on 'PostCommentLike', fields ['user', 'comment']
        db.delete_unique(u'communication_postcommentlike', ['user_id', 'comment_id'])

        # Removing unique constraint on 'DiscussionLike', fields ['user', 'comment']
        db.delete_unique(u'communication_discussionlike', ['user_id', 'comment_id'])

        # Deleting model 'DiscussionLike'
        db.delete_table(u'communication_discussionlike')

        # Deleting model 'PostCommentLike'
        db.delete_table(u'communication_postcommentlike')

        # Deleting model 'ChatMessageLike'
        db.delete_table(u'communication_chatmessagelike')
    ...
    models = {
        ...
        u'communication.chatmessage': {
            ...
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.ChatMessage']", 'null': 'True', 'blank': 'True'}),
        ...
        u'communication.chatmessagelike': {
            'Meta': {'unique_together': "(('user', 'comment'),)", 'object_name': 'ChatMessageLike'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.ChatMessage']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.CustomUser']"})
        },
        u'communication.coursepostrel': {
            'Meta': {'object_name': 'CoursePostRel'},
        ...
        u'communication.discussion': {
            ...
            'reply': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_discussions'", 'null': 'True', 'to': u"orm['communication.Discussion']"}),
            'response': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'discussion_admin_response'", 'null': 'True', 'to': u"orm['communication.Discussion']"}),
        ...
        u'communication.discussionlike': {
            'Meta': {'unique_together': "(('user', 'comment'),)", 'object_name': 'DiscussionLike'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.Discussion']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.CustomUser']"})
        ...
        u'communication.post': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'courses': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'posts'", 'symmetrical': 'False', 'through': u"orm['communication.CoursePostRel']", 'to': u"orm['organisation.Course']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'communication.postcomment': {
            ...
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.Post']"}),
            'publishdate': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.PostComment']", 'null': 'True', 'blank': 'True'}),
        ...
        u'communication.postcommentlike': {
            'Meta': {'unique_together': "(('user', 'comment'),)", 'object_name': 'PostCommentLike'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['communication.PostComment']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.CustomUser']"})
