...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'communication_message', 'to_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='message_for_learner', null=True, to=orm['auth.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.to_user'
        db.delete_column(u'communication_message', 'to_user_id')
