...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Profanity'
        db.create_table(u'communication_profanity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('translation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'communication', ['Profanity'])


    def backwards(self, orm):
        # Deleting model 'Profanity'
        db.delete_table(u'communication_profanity')
