...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportResponse.publish_date'
        db.alter_column(u'communication_reportresponse', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ReportResponse.publish_date'
        db.alter_column(u'communication_reportresponse', 'publish_date', self.gf('django.db.models.fields.DateTimeField')())
