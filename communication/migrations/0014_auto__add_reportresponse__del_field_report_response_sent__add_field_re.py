...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communication_reportresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'communication', ['ReportResponse'])

        # Deleting field 'Report.response_sent'
        db.delete_column(u'communication_report', 'response_sent')

        # Adding field 'Report.response'
        db.add_column(u'communication_report', 'response',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.ReportResponse'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReportResponse'
        db.delete_table(u'communication_reportresponse')

        # Adding field 'Report.response_sent'
        db.add_column(u'communication_report', 'response_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Report.response'
        db.delete_column(u'communication_report', 'response_id')
