...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoursePostRel'
        db.create_table(u'communication_coursepostrel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Course'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Post'])),
        ))
        db.send_create_signal(u'communication', ['CoursePostRel'])


    def backwards(self, orm):
        # Deleting model 'CoursePostRel'
        db.delete_table(u'communication_coursepostrel')
