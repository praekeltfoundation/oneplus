...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Discussion.responded_date'
        db.delete_column(u'communication_discussion', 'responded_date')

        # Adding field 'Discussion.reply'
        db.add_column(u'communication_discussion', 'reply',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='discussion', null=True, to=orm['communication.Discussion']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Discussion.responded_date'
        db.add_column(u'communication_discussion', 'responded_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Discussion.reply'
        db.delete_column(u'communication_discussion', 'reply_id')
    ...
    models = {
        ...
        u'communication.discussion': {
            ...
            'reply': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'discussion'", 'null': 'True', 'to': u"orm['communication.Discussion']"}),
