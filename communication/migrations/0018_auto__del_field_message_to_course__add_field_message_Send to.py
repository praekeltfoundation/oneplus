...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.Send to'
        db.add_column(u'communication_message', 'Send to',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Message.Send to'
        db.delete_column(u'communication_message', 'Send to_id')
    ...
    models = {
        ...
        u'communication.message': {
            ...
            'Send to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organisation.Course']", 'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.CustomUser']", 'null': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
