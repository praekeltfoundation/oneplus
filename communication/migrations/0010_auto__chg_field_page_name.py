...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'communication_page', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Page.name'
        db.alter_column(u'communication_page', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True))
