...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostComment.response'
        db.add_column(u'communication_postcomment', 'response',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.PostComment'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.response'
        db.add_column(u'communication_chatmessage', 'response',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.ChatMessage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostComment.response'
        db.delete_column(u'communication_postcomment', 'response_id')

        # Deleting field 'ChatMessage.response'
        db.delete_column(u'communication_chatmessage', 'response_id')
