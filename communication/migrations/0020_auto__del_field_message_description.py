...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.description'
        db.delete_column(u'communication_message', 'description')


    def backwards(self, orm):
        # Adding field 'Message.description'
        db.add_column(u'communication_message', 'description',
