...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SmsQueue.to_course'
        db.add_column(u'communication_smsqueue', 'to_course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.Course'], null=True),
                      keep_default=False)

        # Adding field 'SmsQueue.to_class'
        db.add_column(u'communication_smsqueue', 'to_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Class'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SmsQueue.to_course'
        db.delete_column(u'communication_smsqueue', 'to_course_id')

        # Deleting field 'SmsQueue.to_class'
        db.delete_column(u'communication_smsqueue', 'to_class_id')
    ...
    models = {
        ...
        u'communication.smsqueue': {
            ...
            'to_class': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Class']", 'null': 'True'}),
            'to_course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organisation.Course']", 'null': 'True'})
        },
