...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report'
        db.create_table(u'communication_report', (
            ...
            ('fix', self.gf('django.db.models.fields.TextField')()),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('response_sent', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'communication', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table(u'communication_report')
    ...
    models = {
        ...
        u'communication.report': {
            ...
            'response_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
