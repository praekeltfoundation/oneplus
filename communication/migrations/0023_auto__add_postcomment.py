...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'communication_postcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='postcomment_user', to=orm['auth.CustomUser'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Post'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('publishdate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('moderated', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('unmoderated_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('unmoderated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unmoderated_user', null=True, to=orm['auth.CustomUser'])),
            ('original_content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'communication', ['PostComment'])


    def backwards(self, orm):
        # Deleting model 'PostComment'
        db.delete_table(u'communication_postcomment')
