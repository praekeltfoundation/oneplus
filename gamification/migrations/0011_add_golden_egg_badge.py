...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        golden_egg = orm.GamificationBadgeTemplate.objects.create(name="Golden Egg")
        orm.GamificationScenario.objects.create(name="Golden Egg", badge=golden_egg, event="GOLDEN_EGG")

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.GamificationScenario.objects.filter(name="Golden Egg").delete()
        orm.GamificationBadgeTemplate.objects.filter(name="Golden Egg").delete()
