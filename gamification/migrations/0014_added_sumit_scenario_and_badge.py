...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        summit = orm.GamificationBadgeTemplate.objects.create(name="Summit")
        orm.GamificationScenario.objects.create(name="Summit",
                                                badge=summit,
                                                event="SUMMIT",
                                                award_type=GamificationScenario.MULTIPLE)
